...
export const CONFIG_SCHEMA = [
  ...
  // ── 레이어 활성화 ────────────────────────────────────
  {
    key: 'layer.learning',
    label: '학습 파이프라인',
    description: '에이전트 실행 후 lessons.md / patterns.md 자동 업데이트',
    file: '.sentix/config.toml',
    section: 'layers.learning',
    tomlKey: 'enabled',
    type: 'bool',
    default: true,
    group: '레이어',
  ...
  {
    key: 'layer.pattern_engine',
    label: '패턴 엔진',
    description: '반복 패턴 감지 및 선제 실행',
    file: '.sentix/config.toml',
    section: 'layers.pattern_engine',
    tomlKey: 'enabled',
    type: 'bool',
  ...
  },
  {
    key: 'layer.visual',
    label: '시각 인지 (실험적)',
    description: '대시보드 UI 자동 생성 레이어',
    file: '.sentix/config.toml',
    section: 'layers.visual',
    tomlKey: 'enabled',
    type: 'bool',
    default: false,
    group: '레이어',
